...
public class ScanCardFragment extends Fragment {
    ...
    @Nullable
    private View mFlashButton, mCloseButton;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mCloseButton = root.findViewById(R.id.iv_close);
        TextView mTitle = root.findViewById(R.id.tv_scan_title);
        TextView mDescription = root.findViewById(R.id.tv_scan_desc);

        mTitle.setText(ScanCardIntent.SCAN_TITLE);
        mDescription.setText(ScanCardIntent.SCAN_DESC);
