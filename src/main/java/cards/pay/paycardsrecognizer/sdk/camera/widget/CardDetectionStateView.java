...
public class CardDetectionStateView extends View {
    ...
    private void init(final Context context) {
        ...
        mCardGradientDrawable = ResourcesCompat.getDrawable(getResources(), R.drawable.wocr_frame_rect_gradient, null);
    ...
    private void initCornerDrawables(Context context) {
        Drawable unwrappedDrawable = AppCompatResources.getDrawable(context, R.drawable.wocr_card_frame_rect_corner_top_left);
        Drawable wrappedDrawable = DrawableCompat.wrap(unwrappedDrawable);
        DrawableCompat.setTint(wrappedDrawable, getResources().getColor(R.color.wocr_color_f8e71c));
//        mCornerTopLeftDrawable = (BitmapDrawable) context.getResources().getDrawable(R.drawable.wocr_card_frame_rect_corner_top_left);
        mCornerTopLeftDrawable = (BitmapDrawable) wrappedDrawable;
        ...
        // change corner right drawable
        mCornerTopRightDrawable.setColorFilter(getResources().getColor(R.color.wocr_color_f8e71c), PorterDuff.Mode.SRC_IN);

        m.setRotate(180);
        mCornerBottomRightDrawable = new BitmapDrawable(context.getResources(),
                Bitmap.createBitmap(bitmap, 0, 0, bitmap.getWidth(), bitmap.getHeight(), m, true));
        // change corner bottom drawable
        mCornerBottomRightDrawable.setColorFilter(getResources().getColor(R.color.wocr_color_f8e71c), PorterDuff.Mode.SRC_IN);

        m.setRotate(270);
        mCornerBottomLeftDrawable = new BitmapDrawable(context.getResources(),
                Bitmap.createBitmap(bitmap, 0, 0, bitmap.getWidth(), bitmap.getHeight(), m, true));
        // change corner left drawable
        mCornerBottomLeftDrawable.setColorFilter(getResources().getColor(R.color.wocr_color_f8e71c), PorterDuff.Mode.SRC_IN);

    }

    private void initLineDrawables(Context context) {
        Drawable unwrappedDrawable = AppCompatResources.getDrawable(context, R.drawable.wocr_card_frame_rect_line_top);
        Drawable wrappedDrawable = DrawableCompat.wrap(unwrappedDrawable);
        DrawableCompat.setTint(wrappedDrawable, getResources().getColor(R.color.wocr_color_f8e71c));
//        mLineTopDrawable = (BitmapDrawable) context.getResources().getDrawable(R.drawable.wocr_card_frame_rect_line_top);
        mLineTopDrawable = (BitmapDrawable) wrappedDrawable;
        Matrix m = new Matrix();
        ...
        mLineRightDrawable = new BitmapDrawable(context.getResources(),
                Bitmap.createBitmap(bitmap, 0, 0, bitmap.getWidth(), bitmap.getHeight(), m, true));
        // change line right draw
        mLineRightDrawable.setColorFilter(getResources().getColor(R.color.wocr_color_f8e71c), PorterDuff.Mode.SRC_IN);

        m.setRotate(180);
        mLineBottomDrawable = new BitmapDrawable(context.getResources(),
                Bitmap.createBitmap(bitmap, 0, 0, bitmap.getWidth(), bitmap.getHeight(), m, true));
        // change line bottom draw
        mLineBottomDrawable.setColorFilter(getResources().getColor(R.color.wocr_color_f8e71c), PorterDuff.Mode.SRC_IN);

        m.setRotate(270);
        mLineLeftDrawable = new BitmapDrawable(context.getResources(),
                Bitmap.createBitmap(bitmap, 0, 0, bitmap.getWidth(), bitmap.getHeight(), m, true));
        // change line left draw
        mLineLeftDrawable.setColorFilter(getResources().getColor(R.color.wocr_color_f8e71c), PorterDuff.Mode.SRC_IN);
    }
